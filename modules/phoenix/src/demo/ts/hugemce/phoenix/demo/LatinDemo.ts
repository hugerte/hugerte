...
import { Attribute, Css, DomEvent, Insert, SugarElement, SugarText } from '@hugemce/sugar';

import { Wrapter } from 'hugemce/phoenix/api/data/Types';
...
const hugemceUi = SugarElement.fromDom(Optional.from(document.getElementById('hugemce-ui')).getOrDie('No element with id "hugemce-id"'));
Insert.append(hugemceUi, p);
