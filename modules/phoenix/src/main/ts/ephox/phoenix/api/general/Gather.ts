...
type BeforeApi = <E, D>(universe: Universe<E, D>, item: E, isRoot: (e: E) => boolean) => (E) | null;
const before: BeforeApi = (universe, item, isRoot) => {
  return seekLeft(universe, item, isLeaf(universe), isRoot);
};

type AfterApi = <E, D>(universe: Universe<E, D>, item: E, isRoot: (e: E) => boolean) => (E) | null;
const after: AfterApi = (universe, item, isRoot) => {
  return seekRight(universe, item, isLeaf(universe), isRoot);
};

type SeekLeftApi = <E, D>(universe: Universe<E, D>, item: E, predicate: (e: E) => boolean, isRoot: (e: E) => boolean) => (E) | null;
const seekLeft: SeekLeftApi = Seeker.left;

type SeekRightApi = <E, D>(universe: Universe<E, D>, item: E, predicate: (e: E) => boolean, isRoot: (e: E) => boolean) => (E) | null;
...
type WalkApi = <E, D>(universe: Universe<E, D>, item: E, mode: Transition, direction: Direction, rules?: Successor[]) => (Traverse<E>) | null;
