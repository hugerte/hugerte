import { Fun, Obj, Optional, Optionals } from '@hugemce/katamari';
import { Attribute, Css, DomEvent, EventArgs, Insert, InsertAll, Ready, Replication, SelectorFind, SugarElement, SugarNode } from '@hugemce/sugar';
...
import { TableResize } from 'hugemce/snooker/api/TableResize';
import { TableSize } from 'hugemce/snooker/api/TableSize';
import { OperationCallback, TargetElement, TargetSelection } from 'hugemce/snooker/model/RunOperation';
...
Ready.document(() => {
  ...
  InsertAll.append(hugemceUi, [ ltrs, rtls ]);
  ...
  Insert.append(hugemceUi, splitCellIntoColumns);
