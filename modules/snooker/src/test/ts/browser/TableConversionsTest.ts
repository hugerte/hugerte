...
import * as TableConversions from 'hugemce/snooker/api/TableConversions';
import { addStyles, assertApproxCellSizes, readWidth } from 'hugemce/snooker/test/SizeUtils';
