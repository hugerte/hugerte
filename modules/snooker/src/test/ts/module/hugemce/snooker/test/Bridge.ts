import { Arr, Fun, Obj, Optional, Optionals } from '@hugemce/katamari';
import { Attribute, Css, Hierarchy, Insert, Replication, SugarElement, SugarNode, TextContent } from '@hugemce/sugar';

import { Generators, SimpleGenerators } from 'hugemce/snooker/api/Generators';
import * as Structs from 'hugemce/snooker/api/Structs';
import { TargetMergable } from 'hugemce/snooker/model/RunOperation';
