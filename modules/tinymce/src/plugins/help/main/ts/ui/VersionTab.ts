...
const tab = (): Dialog.TabSpec & { name: string } => {
  ...
  const changeLogLink = '<a data-alloy-tabstop="true" tabindex="-1" href="https://hugerte.org/docs/tinymce/1/changelog/?utm_campaign=help_dialog_version_tab&utm_source=editor&utm_medium=referral" rel="noopener" target="_blank">TinyMCE ' + version + '</a>';
