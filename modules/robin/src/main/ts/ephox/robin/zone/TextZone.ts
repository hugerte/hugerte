...
const fromRange = <E, D>(universe: Universe<E, D>, start: E, finish: E, envLang: string, onlyLang: string): (Zone<E>) | null => {
...
const fromInline = <E, D>(universe: Universe<E, D>, element: E, envLang: string, onlyLang: string): (Zone<E>) | null => {
  const isLanguageBoundary = LanguageZones.strictBounder(envLang, onlyLang);
...
const scour = <E, D>(universe: Universe<E, D>, element: E, envLang: string, onlyLang: string): (Zone<E>) | null => {
