...
const top: Walks = {
  ...
  rules: [
    { current: Gather.backtrack, next: Gather.sidestep, fallback: null },
    { current: Gather.sidestep, next: Gather.sidestep, fallback: Gather.backtrack },
    { current: Gather.advance, next: Gather.sidestep, fallback: Gather.sidestep }
  ],
