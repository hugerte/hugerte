...
UnitTest.test('BlockTest', () => {
  ...
  check('ol1', [ 'li2', 'li3', 'li4_text' ], Look.selector(doc, 'ol'));
  check(null, [ 'li2', 'li5' ], Look.selector(doc, 'ol'));

  check('ol1', [ 'li2', 'li4' ], Look.predicate(doc, (item: Gene) => Structure.isBlock(doc, item)));
  check('d1', [ 'li1_text', 'li5_text' ], Look.exact(doc, Gene('d1', 'div')));
});
