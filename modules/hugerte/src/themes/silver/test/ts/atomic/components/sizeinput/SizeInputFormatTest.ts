...
import { formatSize } from 'hugerte/themes/silver/ui/sizeinput/SizeInputModel';

describe('atomic.hugerte.themes.silver.components.sizeinput.SizeInputFormatTest', () => {
