...
import { renderAlertBanner } from 'hugerte/themes/silver/ui/general/AlertBanner';

import TestProviders from '../../../module/TestProviders';

describe('headless.hugerte.themes.silver.components.alertbanner.AlertBannerTest', () => {
  const providers = {
    ...TestProviders,
