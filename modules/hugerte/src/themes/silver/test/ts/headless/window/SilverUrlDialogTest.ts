import { ApproxStructure, Assertions, Mouse, TestStore, UiFinder, Waiter } from "@hugerte/agar";
...
describe('headless.hugerte.themes.silver.window.SilverUrlDialogTest', () => {
  ...
  const openDialog = () => {
    dialogApi = windowManager.openUrl({
      ...
      url: '/project/hugerte/src/themes/silver/test/html/iframe.html',
      buttons: [
        {
          type: 'custom',
          name: 'barny',
