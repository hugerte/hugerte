import { ApproxStructure, Assertions, FocusTools, Keys, Mouse, StructAssert, UiFinder, Waiter } from "@hugerte/agar";
...
describe('browser.hugerte.themes.silver.skin.OxideTablePickerMenuTest', () => {
