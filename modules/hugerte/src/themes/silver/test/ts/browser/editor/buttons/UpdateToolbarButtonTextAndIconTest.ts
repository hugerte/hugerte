...
import { TinyHooks, TinyUi, TinyUiActions } from "@hugerte/wrap-mcagar";
...
describe('browser.hugerte.themes.silver.editor.buttons.UpdateToolbarButtonTextAndIconTest', () => {
