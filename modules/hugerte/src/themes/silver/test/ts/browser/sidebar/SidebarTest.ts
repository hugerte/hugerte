import { ApproxStructure, Assertions, TestStore, UiFinder, Waiter } from "@hugerte/agar";
...
import { Sidebar } from 'hugerte/core/api/ui/Ui';
...
describe('browser.hugerte.themes.silver.sidebar.SidebarTest', () => {
