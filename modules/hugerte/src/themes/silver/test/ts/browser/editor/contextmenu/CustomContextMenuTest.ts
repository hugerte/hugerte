import { Keyboard, Keys, Mouse, UiFinder, Waiter } from "@hugerte/agar";
...
describe('browser.hugerte.themes.silver.editor.contextmenu.CustomContextMenuTest', () => {
  ...
  context('Multiple empty context menus', () => {
    ...
    it('TINY-9842: Multiple empty custom context menus should fallback to native context menu', () => {
      ...
      UiFinder.exists(SugarBody.body(), '.tox.tox-silver-sink.tox-hugerte-aux:empty');
    });
  });
});
