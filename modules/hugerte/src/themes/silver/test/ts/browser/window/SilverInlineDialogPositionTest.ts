...
import { Class, Css, Height, Insert, Remove, Scroll, SugarBody, SugarElement, Traverse } from "@hugerte/sugar";
...
describe.skip('browser.hugerte.themes.silver.window.SilverInlineDialogPositionTest', () => {
        ...
        context(editorType, () => {
          ...
          it('TINY-9888: Test bottom inline dialog position when scrolling', async () => {
            ...
            const assertFn = (dialog: SugarElement<HTMLElement>) => {
              ...
              const fixedSink = Class.has(TinyDom.container(editor), 'tox-hugerte--toolbar-sticky-on');
