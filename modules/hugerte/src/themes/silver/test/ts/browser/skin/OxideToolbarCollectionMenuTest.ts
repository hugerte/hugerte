import { ApproxStructure, Assertions, FocusTools, Keys, Mouse, TestStore } from "@hugerte/agar";
...
describe('browser.hugerte.themes.silver.skin.OxideToolbarCollectionMenuTest', () => {
