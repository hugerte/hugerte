...
import * as Options from 'hugerte/themes/silver/ui/menus/contextmenu/Options';

describe('browser.hugerte.themes.silver.editor.contextmenu.ContextMenuSettingsTest', () => {
