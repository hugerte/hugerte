...
import { Scroll, SugarLocation, SugarPosition } from "@hugerte/sugar";
import { TinyDom, TinyHooks } from "@hugerte/wrap-mcagar";
import { assert } from 'chai';

import Editor from 'hugerte/core/api/Editor';
import * as ScrollIntoView from 'hugerte/core/dom/ScrollIntoView';

// TODO TINY-10480: Investigate flaky tests
describe.skip('browser.hugerte.themes.silver.editor.header.StickyHeaderScrollIntoViewTest', () => {
