...
import * as Backstage from 'hugerte/themes/silver/backstage/Backstage';
import * as Options from 'hugerte/themes/silver/ui/core/color/Options';

describe('browser.hugerte.themes.silver.editor.backstage.BackstageSinkTest', () => {
