...
import { getPreviewContent } from 'hugerte/plugins/template/ui/Dialog';
...
const noCorsNoStyle = '<!DOCTYPE html><html><head>' +
  `<base href="http://${host}/">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/hugerte/js/hugerte/skins/ui/oxide/content.min.css">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/hugerte/js/hugerte/skins/content/default/content.css">` +
...
const corsNoStyle = '<!DOCTYPE html><html><head>' +
  `<base href="http://${host}/">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/hugerte/js/hugerte/skins/ui/oxide/content.min.css" crossorigin="anonymous">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/hugerte/js/hugerte/skins/content/default/content.css" crossorigin="anonymous">` +
  '<script>document.addEventListener && document.addEventListener("click", function(e) {for (var elm = e.target; elm; elm = elm.parentNode) {if (elm.nodeName === "A" && !(' +
  metaKey +
...
describe.skip('browser.hugerte.plugins.template.Dialog.getPreviewContent', () => {
