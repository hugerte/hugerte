...
describe('browser.hugerte.plugins.template.TemplateSanityTest', () => {
  ...
  it('TBA: Test loading in snippet from other file', async () => {
    const editor = hook.editor();
    addSettings({
      templates: [{ title: 'a', description: '<strong>b</strong>', url: '/project/hugerte/src/plugins/template/test/html/test_template.html' }]
    });
