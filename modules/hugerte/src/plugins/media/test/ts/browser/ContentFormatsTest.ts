...
describe('browser.hugerte.plugins.media.ContentFormatsTest', () => {
  const settings = {
    plugins: 'media',
    toolbar: 'media',
    base_url: '/project/hugerte/js/hugerte',
    media_live_embeds: false,
    document_base_url: '/hugerte/hugerte/trunk/tests/',
  ...
  it('TBA: Resize complex object', () => {
    ...
    editor.setContent(
      ...
      '<source src="s" />' +
      '<object type="application/x-shockwave-flash" data="../../js/hugerte/plugins/media/moxieplayer.swf" width="300" height="150">' +
      '<param name="allowfullscreen" value="true" />' +
      '<param name="allowscriptaccess" value="always" />' +
      '<param name="flashvars" value="video_src=s" />' +
      '<!--[if IE]><param name="movie" value="../../js/hugerte/plugins/media/moxieplayer.swf" /><![endif]-->' +
      '</object>' +
      '</video>'
    );
    ...
    TinyAssertions.assertContent(editor,
      ...
      '<source src="s">' +
      '<object data="../../js/hugerte/plugins/media/moxieplayer.swf" type="application/x-shockwave-flash" width="100" height="200">' +
      '<param name="allowfullscreen" value="true">' +
      '<param name="allowscriptaccess" value="always">' +
      '<param name="flashvars" value="video_src=s">' +
      '<!--[if IE]>' +
      '<param name="movie" value="../../js/hugerte/plugins/media/moxieplayer.swf" />' +
      '<![endif]-->' +
      '</object>' +
      '</video>' +
      '</p>'
