...
import * as HtmlToData from 'hugerte/plugins/media/core/HtmlToData';
import { MediaData } from 'hugerte/plugins/media/core/Types';

describe('atomic.hugerte.plugins.media.core.HtmlToDataTest', () => {
