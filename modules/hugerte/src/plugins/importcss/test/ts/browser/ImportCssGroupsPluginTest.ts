...
import { Group } from 'hugerte/plugins/importcss/core/ImportCss';
...
describe('browser.hugerte.plugins.importcss.ImportCssGroupsTest', () => {
  before(() => {
    Plugin();
  });
  ...
  it('TBA: content_css with four files (one with clash), groups, and exclusive = false', () => pTestEditorWithSettings(
    ...
    },
    {
      content_css: [
        ...
        '/project/hugerte/src/plugins/importcss/test/css/advanced.css',
        '/project/hugerte/src/plugins/importcss/test/css/other-adv.css',
        '/project/hugerte/src/plugins/importcss/test/css/clashing.css'
      ],
      importcss_append: false,
