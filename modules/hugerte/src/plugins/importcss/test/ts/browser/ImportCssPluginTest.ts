import { ApproxStructure, Assertions, Mouse, UiFinder } from "@hugerte/agar";
...
import Plugin from 'hugerte/plugins/importcss/Plugin';
...
describe('browser.hugerte.plugins.importcss.ImportCssTest', () => {
  before(() => {
    Plugin();
  });
  ...
  it('TBA: content_css with multiple files, append true', () => pTestEditorWithSettings(
    ...
    {
      content_css: [
        '/project/hugerte/src/plugins/importcss/test/css/basic.css',
        '/project/hugerte/src/plugins/importcss/test/css/advanced.css',
        '/project/hugerte/src/plugins/importcss/test/css/other-adv.css'
      ],
      importcss_append: true
    }
  ));
  ...
  it('TINY-8238: content_css with two files, basic and internal CSS classes', () => pTestEditorWithSettings(
    ...
    },
    {
      content_css: [
        '/project/hugerte/src/plugins/importcss/test/css/basic.css',
        '/project/hugerte/src/plugins/importcss/test/css/internal.css'
      ],
      importcss_append: undefined
    }
  ));
