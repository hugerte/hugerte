...
import PageBreakPlugin from 'hugerte/plugins/pagebreak/Plugin';
import QuickbarsPlugin from 'hugerte/plugins/quickbars/Plugin';
...
describe.skip('browser.hugerte.plugins.quickbars.SelectionToolbarTest', () => {
