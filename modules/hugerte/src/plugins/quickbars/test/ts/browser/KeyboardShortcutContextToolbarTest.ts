...
import { TinyHooks, TinySelections, TinyContentActions, TinyUiActions } from "@hugerte/wrap-mcagar";

import Editor from 'hugerte/core/api/Editor';
import Plugin from 'hugerte/plugins/quickbars/Plugin';

describe('browser.hugerte.plugins.quickbars.KeyboardShortcutContextToolbarTest', () => {
