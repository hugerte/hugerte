...
describe.skip('browser.hugerte.plugins.emoticons.ImageEmojiTest', () => {
  const hook = TinyHooks.bddSetupLight<Editor>({
    plugins: 'emoticons',
    toolbar: 'emoticons',
    base_url: '/project/hugerte/js/hugerte',
    emoticons_database_url: '/project/hugerte/src/plugins/emoticons/main/js/emojiimages.js',
    setup: () => {
      Resource.unload('hugerte.plugins.emoticons');
    }
  }, [ Plugin ], true);
