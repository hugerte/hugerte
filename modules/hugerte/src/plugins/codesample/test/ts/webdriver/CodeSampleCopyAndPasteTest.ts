import { ApproxStructure, Keys, RealClipboard, RealMouse, StructAssert } from "@hugerte/agar";
...
describe('webdriver.hugerte.plugins.codesample.CodeSampleCopyAndPasteTest', () => {
