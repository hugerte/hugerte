import { FocusTools, Keys, Mouse, UiControls, UiFinder } from "@hugerte/agar";
import { describe, it } from '@ephox/bedrock-client';
import { SugarBody, SugarDocument, Value } from "@hugerte/sugar";
import { TinyAssertions, TinyDom, TinyHooks, TinySelections, TinyUiActions } from "@hugerte/wrap-mcagar";
import { assert } from 'chai';

import Editor from 'hugerte/core/api/Editor';
import { ExecCommandEvent } from 'hugerte/core/api/EventTypes';
import { EditorEvent } from 'hugerte/core/api/util/EventDispatcher';
import Plugin from 'hugerte/plugins/lists/Plugin';

describe('browser.hugerte.plugins.lists.ListPropertiesTest', () => {
  ...
  const contentMenuSelector = '.tox-hugerte-aux .tox-menu .tox-collection__item:contains("List properties...")';
