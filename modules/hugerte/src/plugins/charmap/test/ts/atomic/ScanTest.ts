...
import { CharMap } from 'hugerte/plugins/charmap/core/CharMap';
import * as Scan from 'hugerte/plugins/charmap/core/Scan';

describe('atomic.hugerte.plugins.charmap.ScanTest', () => {
