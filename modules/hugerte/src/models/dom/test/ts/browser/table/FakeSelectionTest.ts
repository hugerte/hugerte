...
import { Html, SelectorFilter, SelectorFind, SugarElement } from "@hugerte/sugar";
import { TinyAssertions, TinyContentActions, TinyDom, TinyHooks, TinySelections, TinyState } from "@hugerte/wrap-mcagar";
import { assert } from 'chai';

import Editor from 'hugerte/core/api/Editor';
import { EditorEvent } from 'hugerte/core/api/util/EventDispatcher';
import { TableSelectionChangeEvent } from 'hugerte/models/dom/table/api/Events';

import * as TableTestUtils from '../../module/table/TableTestUtils';

describe('browser.hugerte.models.dom.table.FakeSelectionTest', () => {
