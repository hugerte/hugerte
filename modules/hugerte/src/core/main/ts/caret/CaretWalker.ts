 ...
 *
 * @private
 * @class hugerte.caret.CaretWalker
 * @example
...
export const CaretWalker = (root: Node): CaretWalker => ({
  /**
     ...
     *
     * @method next
     * @param {hugerte.caret.CaretPosition} caretPosition Caret position to start from.
     * @return {hugerte.caret.CaretPosition} CaretPosition or null if no position was found.
     */
  next: (caretPosition: CaretPosition | null): CaretPosition | null => {
