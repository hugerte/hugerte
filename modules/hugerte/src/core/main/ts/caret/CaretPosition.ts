 ...
 *
 * @private
 * @class hugerte.caret.CaretPosition
 * @example
...
export const CaretPosition = (container: Node, offset: number, clientRects?: GeomClientRect[]): CaretPosition => {
  ...
  return {
     ...
     *
     * @method isEqual
     * @param {hugerte.caret.CaretPosition} caretPosition Caret position to compare with.
 ...
 * @return {hugerte.caret.CaretPosition} Caret position from the start of DOM range.
 */
 ...
 * @method fromRangeEnd
 * @param {DOMRange} range DOM Range to create caret position from.
 * @return {hugerte.caret.CaretPosition} Caret position from the end of DOM range.
 */
 ...
 * @return {hugerte.caret.CaretPosition} Caret position from the node.
 */
