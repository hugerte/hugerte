 ...
 *
 * @class hugerte.html.Serializer
 * @version 3.4
 * @example
 * hugerte.html.Serializer().serialize(hugerte.html.DomParser().parse('<p>text</p>'));
 */
...
const HtmlSerializer = (settings: HtmlSerializerSettings = {}, schema: Schema = Schema()): HtmlSerializer => {
   ...
   *
   * @method serialize
   * @param {hugerte.html.Node} node Node instance to serialize.
