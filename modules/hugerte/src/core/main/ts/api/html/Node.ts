 ...
 *
 * @class hugerte.html.Node
 * @version 3.4
 * @example
 * const node = new hugerte.html.Node('strong', 1);
...
class AstNode {
   ...
   *
   * @method replace
   * @param {hugerte.html.Node} node Node to replace the current node with.
   * @return {hugerte.html.Node} The old node that got replaced.
   * @example
   ...
   * @return {String/hugerte.html.Node} String or undefined on a get operation or the current node on a set operation.
   * @example
   ...
   *
   * @method clone
   * @return {hugerte.html.Node} New copy of the original node.
   * @example
   ...
   *
   * @method remove
   * @return {hugerte.html.Node} Current node that got removed.
   * @example
   * node.remove();
   */
   ...
   *
   * @method append
   * @param {hugerte.html.Node} node Node to append as a child of the current one.
   * @return {hugerte.html.Node} The node that got appended.
   * @example
   ...
   *
   * @method insert
   * @param {hugerte.html.Node} node Node to insert as a child of this node.
   * @param {hugerte.html.Node} refNode Reference node to set node before/after.
   * @param {Boolean} before Optional state to insert the node before the reference node.
   * @return {hugerte.html.Node} The node that got inserted.
   * @example
   ...
   *
   * @method empty
   * @return {hugerte.html.Node} The current node that got cleared.
   */
   ...
   * @return {hugerte.html.Node} Node that is next to or previous of the current node.
   */
