...
/**
 * This mixin contains the event logic for the hugerte.Editor class.
 *
 * @mixin hugerte.EditorObservable
 * @extends hugerte.util.Observable
 * @private
 */
 ...
 *
 * @private
 * @param {hugerte.Editor} editor Editor instance to get event target from.
