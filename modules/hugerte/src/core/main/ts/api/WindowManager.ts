 ...
 * hugerte.activeEditor.windowManager.confirm('Do you want to do something?', (state) => {
 *   const message = state ? 'Ok' : 'Cancel';
 *   hugerte.activeEditor.windowManager.alert(message);
 * });
 */
...
const WindowManager = (editor: Editor): WindowManager => {
  ...
  return {
     ...
     *
     * @method open
     * @param {Object} config For information on the available options, see: <a href="https://www.hugerte.org/docs/hugerte/1/dialog-configuration/#options">Dialog - Configuration options</a>.
     * @param {Object} params (Optional) For information on the available options, see: <a href="https://www.hugerte.org/docs/hugerte/1/dialog-configuration/#configuration-parameters">Dialog - Configuration parameters</a>.
     ...
     *
     * @method openUrl
     * @param {Object} config For information on the available options, see: <a href="https://www.hugerte.org/docs/hugerte/1/urldialog/#configuration">URL dialog - Configuration</a>.
