...
class URI {
   ...
   * const url = new hugerte.util.URI('http://www.site.com/dir/').toRelative('http://www.site.com/dir/somedir/somefile.htm');
   */
   ...
   * const url = new hugerte.util.URI('http://www.site.com/dir/').toAbsolute('somedir/somefile.htm');
   */
   ...
   *
   * @method isSameOrigin
   * @param {hugerte.util.URI} uri Uri instance to compare.
