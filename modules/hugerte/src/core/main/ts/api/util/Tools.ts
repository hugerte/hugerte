 ...
 * directly on the hugerte namespace.
 *
 * @class hugerte.util.Tools
 */
 ...
 * const obj = hugerte.resolve('a.b.c.d');
 */
...
const Tools: Tools = {
   ...
   * @example
   * // Iterate an array
   * hugerte.each([ 1,2,3 ], (v, i) => {
   *   console.debug("Value: " + v + ", Index: " + i);
   * });
   *
   * // Iterate an object
   * hugerte.each({ a: 1, b: 2, c: 3 }, (v, k) => {
   ...
   * const items = hugerte.grep([ 1,2,3,4,5 ], (v) => v > 3);
   */
