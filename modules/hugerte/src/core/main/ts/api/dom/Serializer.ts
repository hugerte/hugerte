...
/**
 * This class is used to serialize DOM trees into a string. Consult the HugeRTE API Documentation for
 * more details and examples on how to use this class.
 *
 * @class hugerte.dom.Serializer
 */
...
const DomSerializer = (settings: DomSerializerSettings, editor?: Editor): DomSerializer => {
  ...
  return {
     ...
     *
     * @field {hugerte.html.Schema} schema
     */
     ...
     * Consult the HugeRTE Documentation for more details on this format.
     *
     * @method addRules
