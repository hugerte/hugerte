 ...
 *
 * @class hugerte.dom.DOMUtils
 * @example
 * // Add a class to an element by id in the page
 * hugerte.DOM.addClass('someid', 'someclass');
 *
 * // Add a class to an element by id inside the editor
 * hugerte.activeEditor.dom.addClass('someid', 'someclass');
 */
...
/**
 * Constructs a new DOMUtils instance. Consult the HugeRTE Documentation for more details on settings etc for this class.
 *
 * @private
 * @constructor
 * @method DOMUtils
...
const DOMUtils = (doc: Document, settings: Partial<DOMUtilsSettings> = {}): DOMUtils => {
  ...
  const self: DOMUtils = {
     ...
     * hugerte.activeEditor.dom.addClass(hugerte.activeEditor.dom.select('span.test'), 'someclass')
     */
    select,
     ...
     * hugerte.activeEditor.dom.add(hugerte.activeEditor.getBody(), 'p', { title: 'my title' }, 'Some content');
     */
    add,
     ...
     * var el = hugerte.activeEditor.dom.create('div', { id: 'test', 'class': 'myclass' }, 'some content');
     * hugerte.activeEditor.selection.setNode(el);
     */
    create,
     ...
     * hugerte.activeEditor.selection.setContent(hugerte.activeEditor.dom.createHTML('a', { href: 'test.html' }, 'some line'));
     */
    createHTML,
     ...
     * hugerte.activeEditor.dom.remove(hugerte.activeEditor.dom.select('p'));
     *
     * // Removes an element by id in the document
     * hugerte.DOM.remove('mydiv');
     */
    remove,
     ...
     * hugerte.activeEditor.dom.setStyle(hugerte.activeEditor.dom.select('p'), 'background-color', 'red');
     *
     * // Sets a style value to an element by id in the current document
     * hugerte.DOM.setStyle('mydiv', 'background-color', 'red');
     */
    setStyle,
     ...
     * hugerte.activeEditor.dom.setStyles(hugerte.activeEditor.dom.select('p'), { 'background-color': 'red', 'color': 'green' });
     *
     * // Sets styles to an element by id in the current document
     * hugerte.DOM.setStyles('mydiv', { 'background-color': 'red', 'color': 'green' });
     */
    setStyles,
     ...
     * hugerte.activeEditor.dom.setAttrib(hugerte.activeEditor.dom.select('p'), 'class', 'myclass');
     *
     * // Sets class attribute on a specific element in the current page
     * hugerte.dom.setAttrib('mydiv', 'class', 'myclass');
     */
    setAttrib,
     ...
     * hugerte.activeEditor.dom.setAttribs(hugerte.activeEditor.dom.select('p'), { 'class': 'myclass', title: 'some title' });
     *
     * // Sets class and title attributes on a specific element in the current page
     * hugerte.DOM.setAttribs('mydiv', { 'class': 'myclass', title: 'some title' });
     */
    setAttribs,
     ...
     * hugerte.DOM.loadCSS('somepath/some.css');
     *
     * // Loads a CSS file into the currently active editor instance
     * hugerte.activeEditor.dom.loadCSS('somepath/some.css');
     *
     * // Loads a CSS file into an editor instance by id
     * hugerte.get('someid').dom.loadCSS('somepath/some.css');
     *
     * // Loads multiple CSS files into the current document
     * hugerte.DOM.loadCSS('somepath/some.css,somepath/someother.css');
     */
    loadCSS,
     ...
     * hugerte.activeEditor.dom.addClass(hugerte.activeEditor.dom.select('p'), 'myclass');
     *
     * // Adds a class to a specific element in the current page
     * hugerte.DOM.addClass('mydiv', 'myclass');
     */
    addClass,
     ...
     * hugerte.activeEditor.dom.removeClass(hugerte.activeEditor.dom.select('p'), 'myclass');
     *
     * // Removes a class from a specific element in the current page
     * hugerte.DOM.removeClass('mydiv', 'myclass');
     */
    removeClass,
     ...
     * hugerte.activeEditor.dom.setHTML(hugerte.activeEditor.dom.select('p'), 'some inner html');
     *
     * // Sets the inner HTML of an element by id in the document
     * hugerte.DOM.setHTML('mydiv', 'some inner html');
     */
    setHTML,
     ...
     * @example
     * hugerte.DOM.getOuterHTML(editorElement);
     * hugerte.activeEditor.getOuterHTML(hugerte.activeEditor.getBody());
     */
    getOuterHTML,
     ...
     * hugerte.activeEditor.dom.setOuterHTML(hugerte.activeEditor.dom.select('p'), '<div>some html</div>');
     *
     * // Sets the outer HTML of an element by id in the document
     * hugerte.DOM.setOuterHTML('mydiv', '<div>some html</div>');
     */
    setOuterHTML,
     ...
     * @example
     * hugerte.DOM.isEmpty(node, { img: true });
     */
    isEmpty,

    /**
     * Creates a new DOM Range object. This will use the native DOM Range API if it's
     * available. If it's not, it will fall back to the custom HugeRTE implementation.
     *
     * @method createRng
     * @return {DOMRange} DOM Range object.
     * @example
     * const rng = hugerte.DOM.createRng();
     ...
     * <br>
     * <em>Deprecated in HugeRTE 6.0 and has been marked for removal in HugeRTE 7.0. Use <code>dispatch</code> instead.</em>
     *
     * @method fire
