 ...
 * Consult the HugeRTE API Documentation for more details and examples on how to use this class.
 *
 * @class hugerte.dom.Selection
 * @example
 * // Getting the currently selected node for the active editor
 * alert(hugerte.activeEditor.selection.getNode().nodeName);
 */
 ...
 * @constructor
 * @method Selection
 * @param {hugerte.dom.DOMUtils} dom DOMUtils object reference.
 * @param {Window} win Window to bind the selection object to.
 * @param {hugerte.dom.Serializer} serializer DOM serialization class to use for getContent.
 * @param {hugerte.Editor} editor Editor instance of the selection.
 */
const EditorSelection = (dom: DOMUtils, win: Window, serializer: DomSerializer, editor: Editor): EditorSelection => {
   ...
   * alert(hugerte.activeEditor.selection.getContent({ format: 'text' }));
   */
   ...
   * hugerte.activeEditor.selection.setContent('<strong>Some contents</strong>');
   */
   ...
   * const bm = hugerte.activeEditor.selection.getBookmark();
   *
   * hugerte.activeEditor.setContent(hugerte.activeEditor.getContent() + 'Some new content');
   *
   ...
   * hugerte.activeEditor.selection.setNode(hugerte.activeEditor.dom.create('img', { src: 'some.gif', title: 'some title' }));
   */
