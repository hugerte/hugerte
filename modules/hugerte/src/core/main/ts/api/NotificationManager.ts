...
/**
 * This class handles the creation of HugeRTE's notifications.
 *
 * @class hugerte.NotificationManager
 * @example
...
const NotificationManager = (editor: Editor): NotificationManager => {
  ...
  return {
     ...
     * <br /><br />
     * For information on the available settings, see: <a href="https://www.hugerte.org/docs/hugerte/1/creating-custom-notifications/">Create custom notifications</a>.
     */
    open,
