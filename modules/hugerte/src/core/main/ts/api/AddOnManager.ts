...
/**
 * HugeRTE theme pseudo class. Allows for a custom theme to be used with HugeRTE when registered using the ThemeManager.
 *
 * @summary This is a pseudo class that describes how to create a custom theme for HugeRTE.
 * <br><br>
 ...
 * @class hugerte.Theme
 * @example
 * hugerte.ThemeManager.add('MyTheme', (editor) => {
...
/**
 * HugeRTE plugin psuedo class. Allows for custom plugins to be added to HugeRTE when registered using the PluginManager.
 *
 * @summary This is a pseudo class that describes how to create a custom plugin for HugeRTE.
 * <br><br>
 ...
 *
 * @class hugerte.Plugin
 * @example
 * hugerte.PluginManager.add('MyPlugin', (editor, url) => {
...
const AddOnManager = <T>(): AddOnManager<T> => {
  ...
  return {
     ...
     * @return {hugerte.Theme/hugerte.Plugin} Theme or plugin add-on instance or undefined.
     */
    get,
     ...
     * @param {hugerte.Theme/hugerte.Plugin} addOn Theme or plugin to add.
     * @return {hugerte.Theme/hugerte.Plugin} The same theme or plugin instance that got passed in.
     * @example
     ...
     * hugerte.PluginManager.add('test', TestPlugin);
     *
     * // Initialize HugeRTE
     * hugerte.init({
     *   ...
     ...
     * hugerte.PluginManager.load('myplugin', '/some/dir/someplugin/plugin.js');
     *
     * // Initialize HugeRTE
     * hugerte.init({
     *   ...
