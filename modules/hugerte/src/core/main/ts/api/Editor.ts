...
/**
 * This class contains the core logic for a HugeRTE editor.
 *
 * @class hugerte.Editor
 * @mixes hugerte.util.Observable
 * @example
 * // Add a class to all paragraphs in the editor.
 * hugerte.activeEditor.dom.addClass(hugerte.activeEditor.dom.select('p'), 'someclass');
 *
 * // Gets the current editors selection as text
 * hugerte.activeEditor.selection.getContent({ format: 'text' });
 *
 * // Creates a new editor instance
 * const ed = new hugerte.Editor('textareaid', {
 *   some_setting: 1
 ...
 *
 * @include ../../../../../tools/docs/hugerte.Editor.js
 */
...
class Editor implements EditorObservable {
   ...
   * hugerte.activeEditor.plugins.someplugin.someMethod();
   */
  public plugins: Record<string, Plugin> = {};

  /**
   * URI object to document configured for the HugeRTE instance.
   *
   * @property documentBaseURI
   * @type hugerte.util.URI
   * @example
   * // Get relative URL from the location of document_base_url
   * hugerte.activeEditor.documentBaseURI.toRelative('/somedir/somefile.htm');
   *
   * // Get absolute URL from the location of document_base_url
   * hugerte.activeEditor.documentBaseURI.toAbsolute('somefile.htm');
   */
  public documentBaseURI: URI;

  /**
   * URI object to current document that holds the HugeRTE editor instance.
   *
   * @property baseURI
   * @type hugerte.util.URI
   * @example
   * // Get relative URL from the location of the API
   * hugerte.activeEditor.baseURI.toRelative('/somedir/somefile.htm');
   *
   * // Get absolute URL from the location of the API
   * hugerte.activeEditor.baseURI.toAbsolute('somefile.htm');
   */
  public baseURI: URI;
   ...
   * @param {hugerte.EditorManager} editorManager EditorManager instance.
   */
  ...
  /**
   * Focuses/activates the editor. This will set this editor as the activeEditor in the hugerte collection
   ...
   * <br>
   * <em>Deprecated in HugeRTE 6.0 and has been marked for removal in HugeRTE 7.0. Use the <code>editor.options.get</code> API instead.</em>
   *
   * @method getParam
   ...
   * const someval = hugerte.activeEditor.getParam('myvalue');
   *
   * // Returns a specific config value from a specific editor instance by id
   * const someval2 = hugerte.get('my_editor').getParam('myvalue');
   */
   ...
   *
   * @method hasPlugin
   * @param {String} name The name of the plugin, as specified for the HugeRTE `plugins` option.
   ...
   * hugerte.activeEditor.hasPlugin('tinycomments', true);
   ...
   * the hugerte command identifiers documentation.
   *
   * @method execCommand
   ...
   * hugerte.activeEditor.setProgressState(true);
   *
   * // Hide progress for the active editor
   * hugerte.activeEditor.setProgressState(false);
   *
   * // Show progress after 3 seconds
   * hugerte.activeEditor.setProgressState(true, 3000);
   */
   ...
   * <br>
   * <em>Note: The content return value was deprecated in HugeRTE 6.0 and has been marked for removal in HugeRTE 7.0.</em>
   *
   * @method setContent
   ...
   * hugerte.activeEditor.setContent('<span>some</span> html');
   *
   * // Sets the content of a specific editor (my_editor in this example)
   * hugerte.get('my_editor').setContent(data);
   *
   * // Sets the content of the activeEditor editor using the specified format
   * hugerte.activeEditor.setContent('<p>Some html</p>', { format: 'html' });
   */
   ...
   * console.debug(hugerte.activeEditor.getContent());
   *
   * // Get the contents of the currently active editor as plain text
   * hugerte.activeEditor.getContent({ format: 'text' });
   *
   * // Get content of a specific editor:
   * hugerte.get('content id').getContent()
   */
   ...
   * @example
   * if (hugerte.activeEditor.isDirty()) {
  ...
  /**
   * Returns the target element/textarea that got replaced with a HugeRTE editor instance.
   *
   * @method getElement
  ...
  /**
   * Removes the editor from the dom and hugerte collection.
   *
   * @method remove
   */
  public remove(): void {
