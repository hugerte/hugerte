...
/**
 * HugeRTE Editor Upload API
 * Handles image uploads, updates undo stack and patches over various internal functions.
 *
 * @class hugerte.EditorUpload
 * @example
 * // Apply a new filter within the image scan.
 * hugerte.activeEditor.EditorUpload.addFilter((image) => {
 ...
 * hugerte.activeEditor.EditorUpload.uploadImages();
 *
 * // Scan the editor for valid images
 * hugerte.activeEditor.EditorUpload.scanForImages();
 */
