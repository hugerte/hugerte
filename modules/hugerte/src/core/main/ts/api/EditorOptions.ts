...
/**
 * HugeRTE Editor Options API. The options API provides the ability to register, lookup and set editor options.
 *
...
export interface Options {
  /**
   * Register a new option that can be used within HugeRTE.
   *
   * @method register
