 ...
 * @private
 * @static
 * @class hugerte.caret.CaretBookmark
 * @example
...
export {
   ...
   * @param {hugerte.caret.CaretPosition} caretPosition Caret position within the root node.
   ...
   * @return {hugerte.caret.CaretPosition} Caret position resolved from xpath like bookmark.
   */
  resolve
};
