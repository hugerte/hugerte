import { DataTransfer, DataTransferContent } from "@hugerte/dragster";
import { Arr, Optional, Singleton, Throttler, Type } from "@hugerte/katamari";
 ...
 *
 * @private
 * @class hugerte.DragDropOverrides
 */
