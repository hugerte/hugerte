...
const Quirks = (editor: Editor): Quirks => {
   ...
   * left there. HugeRTE sees a floating text node and wraps it in a paragraph on the key up event (ForceBlocks.js
  ...
  /**
   * WebKit will produce DIV elements here and there by default. But since HugeRTE uses paragraphs by
