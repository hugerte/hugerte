...
import DomParser, { DomParserSettings, ParserArgs, ParserFilterCallback } from 'hugerte/core/api/html/DomParser';
import AstNode, { Attributes } from 'hugerte/core/api/html/Node';
import Schema, { SchemaElement, SchemaSettings } from 'hugerte/core/api/html/Schema';
...
describe('browser.hugerte.core.html.DomParserTest', () => {
  ...
  },
  {
    ...
    context(scenario.name, () => {
      ...
      it('TINY-7847: removeAttributeFilter', () => {
        ...
        parser.addAttributeFilter('controls,poster', () => {});
        ...
        parser.removeAttributeFilter('controls', () => {});
