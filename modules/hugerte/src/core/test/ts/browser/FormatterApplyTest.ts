...
describe('browser.hugerte.core.FormatterApplyTest', () => {
  ...
  it('Bug #5134 - HugeRTE removes formatting tags in the getContent', () => {
    const editor = hook.editor();
    editor.setContent('');
    editor.formatter.register('format', {
      inline: 'strong',
    ...
    editor.formatter.apply('format');
    assert.equal(getContent(editor), '', 'empty HugeRTE');
    editor.selection.setContent('a');
    assert.equal(getContent(editor), '<p><strong>a</strong></p>', 'bold text inside HugeRTE');
  });

  it('Bug #5134 - HugeRTE removes formatting tags in the getContent - typing', () => {
    const editor = hook.editor();
    editor.setContent('');
    editor.formatter.register('format', {
      inline: 'strong',
