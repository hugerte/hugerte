...
import { LegacyUnit, TinyAssertions, TinyHooks, TinySelections, TinyState } from "@hugerte/wrap-mcagar";
import { assert } from 'chai';

import Editor from 'hugerte/core/api/Editor';

describe('browser.hugerte.core.FormattingCommandsTest', () => {
  ...
  context('Formatting commands (alignInline)', () => {
    ...
    it('TBA - img, JustifyLeft', () => {
      const editor = hook.editor();
      editor.setContent('<img src="hugerte/ui/img/raster.gif" />');
      editor.selection.select(editor.dom.select('img')[0]);
      editor.execCommand('JustifyLeft');
      TinyAssertions.assertContent(editor, '<p><img style="float: left;" src="hugerte/ui/img/raster.gif"></p>');
    });
    ...
    it('TBA - img, JustifyCenter', () => {
      ...
      TinyAssertions.assertContent(
        editor,
        '<p><img style="margin-right: auto; margin-left: auto; display: block;" src="hugerte/ui/img/raster.gif"></p>'
      );
    });
    ...
    it('TBA - img, JustifyRight', () => {
      ...
      editor.selection.select(editor.dom.select('img')[0]);
      editor.execCommand('JustifyRight');
      TinyAssertions.assertContent(editor, '<p><img style="float: right;" src="hugerte/ui/img/raster.gif"></p>');
    });
  });
