...
import { McEditor, TinyAssertions } from "@hugerte/wrap-mcagar";
import { assert } from 'chai';

import Editor from 'hugerte/core/api/Editor';

describe('browser.hugerte.core.focus.CefFocusTest', () => {
  ...
  it('Focus editors', async () => {
    const editor1 = await pCreateInlineEditor('<div class="hugerte"><p contenteditable="false">a</p></div>');
    const editor2 = await pCreateInlineEditor('<div class="hugerte"><p contenteditable="false">b</p></div>');
