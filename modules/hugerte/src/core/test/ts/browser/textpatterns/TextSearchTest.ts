...
import { SpotPoint } from 'hugerte/core/alien/Spot';
import * as TextSearch from 'hugerte/core/alien/TextSearch';
import Editor from 'hugerte/core/api/Editor';

describe('browser.hugerte.core.textpatterns.TextSearchTest', () => {
