...
import * as InlinePattern from 'hugerte/core/textpatterns/core/InlinePattern';
import {
  DynamicPatternContext, InlinePattern as InlinePatternType, InlinePatternMatch, PatternSet
} from 'hugerte/core/textpatterns/core/PatternTypes';
import { PathRange } from 'hugerte/core/textpatterns/utils/PathRange';
import { getBeforeText, getParentBlock, resolveFromDynamicPatterns } from 'hugerte/core/textpatterns/utils/Utils';
import ListsPlugin from 'hugerte/plugins/lists/Plugin';

import { getPatternSetFor } from '../../module/test/TextPatternsUtils';

describe('browser.hugerte.textpatterns.FindInlinePatternTest', () => {
