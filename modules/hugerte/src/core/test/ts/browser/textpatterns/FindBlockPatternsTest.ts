...
import * as BlockPattern from 'hugerte/core/textpatterns/core/BlockPattern';
import { DynamicPatternContext, PatternSet } from 'hugerte/core/textpatterns/core/PatternTypes';
import { getParentBlock, resolveFromDynamicPatterns } from 'hugerte/core/textpatterns/utils/Utils';

import { getPatternSetFor } from '../../module/test/TextPatternsUtils';

// Similar to modules/hugerte/src/core/test/ts/atomic/textpatterns/FindBlockPatternsTest.ts
// but uses DOM and includes tests for text_patterns_lookup
describe('browser.hugerte.textpatterns.FindBlockPatternsTest', () => {
