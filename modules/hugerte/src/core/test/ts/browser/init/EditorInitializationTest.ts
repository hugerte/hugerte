...
import { Attribute, SelectorFilter, SugarElement } from "@hugerte/sugar";
...
describe('browser.hugerte.core.init.EditorInitializationTest', () => {
  const viewBlock = ViewBlock.bddSetup();

  before(() => {
    EditorManager._setBaseUrl('/project/hugerte/js/hugerte');
  ...
  const pCreateInlineModeMultipleInstances = (): Promise<Editor[]> => {
    viewBlock.update('<div class="hugerte-editor"><p>a</p></div><div class="hugerte-editor"><p>b</p></div>');
