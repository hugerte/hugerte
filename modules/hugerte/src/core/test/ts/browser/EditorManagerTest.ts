...
describe('browser.hugerte.core.EditorManagerTest', () => {
  ...
  it('get', (done) => {
    viewBlock.update('<textarea class="hugerte"></textarea>');
    EditorManager.init({
    ...
    EditorManager.init({
      ...
      init_instance_callback: (editor1) => {
        setTimeout(() => {
          ...
          EditorManager.init({
            selector: 'textarea',
            skin_url: '/project/hugerte/js/hugerte/skins/ui/oxide',
            content_css: '/project/hugerte/js/hugerte/skins/content/default',
