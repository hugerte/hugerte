...
import { AutocompleterEventArgs, AutocompleteLookupData } from 'hugerte/core/autocomplete/AutocompleteTypes';

describe('browser.hugerte.core.keyboard.AutocompleterTest', () => {
