...
describe('browser.hugerte.core.dom.ScriptLoaderTest', () => {
  const testScript = '/project/hugerte/src/core/test/assets/js/test.js';
  const nestedScript = '/project/hugerte/src/core/test/assets/js/nested.js';
  const invalidScript = '/project/hugerte/src/core/test/assets/js/invalid.js';
  let loadedCount = 0;
