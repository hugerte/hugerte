...
describe('browser.hugerte.core.dom.DOMUtilsTest', () => {
  ...
  it('loadCSS', () => {
    ...
    DOM.loadCSS('hugerte/dom/test.css?a=1,hugerte/dom/test.css?a=2,hugerte/dom/test.css?a=3');
  ...
  it('loadCSS contentCssCors enabled', () => {
    ...
    CustomDOM.loadCSS('hugerte/dom/test_cors.css?a=1,hugerte/dom/test_cors.css?a=2,hugerte/dom/test_cors.css?a=3');
  ...
  it('isEmpty', () => {
    ...
    DOM.setHTML('test', '<img src="hugerte/ui/img/raster.gif">');
    assert.isFalse(DOM.isEmpty(getTestElement()));
