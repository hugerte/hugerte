...
import { LegacyUnit, TinyAssertions, TinyHooks, TinySelections } from "@hugerte/wrap-mcagar";
import { assert } from 'chai';

import Editor from 'hugerte/core/api/Editor';
import { GetContentEvent, SetContentEvent } from 'hugerte/core/api/EventTypes';
import { EditorEvent } from 'hugerte/core/api/util/EventDispatcher';
import { Bookmark } from 'hugerte/core/bookmark/BookmarkTypes';
import * as CaretContainer from 'hugerte/core/caret/CaretContainer';
import * as Zwsp from 'hugerte/core/text/Zwsp';

describe('browser.hugerte.core.dom.SelectionTest', () => {
