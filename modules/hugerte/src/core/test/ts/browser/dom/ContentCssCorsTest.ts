...
describe('browser.hugerte.core.dom.ContentCssCorsTest', () => {
  const settings = {
  ...
  context('Classic mode: Editor StyleSheetLoader is separate from global (hugerte)', () => {
  ...
  context('Inline mode: Global (hugerte) StyleSheetLoader is shared amongst multiple inline editors', () => {
  ...
  context('Classic and inline editors: Global (hugerte) StyleSheetLoader is shared amongst multiple inline editors, but classic editor has separate stylesheetloader', () => {
