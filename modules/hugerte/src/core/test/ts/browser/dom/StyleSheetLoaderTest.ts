...
describe('browser.hugerte.core.dom.StyleSheetLoaderTest', () => {
  const contentCss = '/project/hugerte/js/hugerte/skins/content/default/content.css';
  const skinCss = '/project/hugerte/js/hugerte/skins/ui/oxide/skin.css';
