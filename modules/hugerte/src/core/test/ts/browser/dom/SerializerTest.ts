...
import DomSerializer from 'hugerte/core/api/dom/Serializer';
...
describe('browser.hugerte.core.dom.SerializerTest', () => {
  ...
  it('Schema rules', () => {
    ...
    setTestHtml('<img title="test" src="hugerte/ui/img/raster.gif" data-mce-src="hugerte/ui/img/raster.gif" alt="test" ' +
    ...
    setTestHtml('<br /><hr /><input type="text" name="test" value="val" class="no" />' +
      ...
      'data-mce-href="file.html">link</a><a name="anchor"></a><a>no</a><img src="hugerte/ui/img/raster.gif" ' +
      'data-mce-src="hugerte/ui/img/raster.gif" />');
    assert.equal(ser.serialize(getTestElement()), '<div id="test"><br><hr><input type="text" name="test" value="val">' +
      ...
      '<a name="anchor"></a>no<img src="hugerte/ui/img/raster.gif" border="0" title="mce_0"></div>', 'Output name and attribute rules');

    ser.setRules('img[src|border=0|alt=]');
    setTestHtml('<img src="hugerte/ui/img/raster.gif" data-mce-src="hugerte/ui/img/raster.gif" border="0" alt="" />');
    assert.equal(ser.serialize(getTestElement()), '<img src="hugerte/ui/img/raster.gif" border="0" alt="">', 'Default attribute with empty value');

    ser.setRules('img[src|border=0|alt=],div[style|id],*[*]');
    setTestHtml('<img src="hugerte/ui/img/raster.gif" data-mce-src="hugerte/ui/img/raster.gif" /><hr />');
    assert.equal(
      ser.serialize(getTestElement(), { getInner: true }),
      '<img src="hugerte/ui/img/raster.gif" border="0" alt=""><hr>'
    );
    ...
    setTestHtml('<img src="hugerte/ui/img/raster.gif" data-mce-src="hugerte/ui/img/raster.gif" alt="" />');
    assert.equal(
      ser.serialize(getTestElement()),
      '<div id="test"><img src="hugerte/ui/img/raster.gif" alt=""></div>'
    );

    ser = DomSerializer({ invalid_elements: 'hr,br' });
    setTestHtml('<img src="hugerte/ui/img/raster.gif" data-mce-src="hugerte/ui/img/raster.gif" /><hr /><br />');
    assert.equal(
      ser.serialize(getTestElement(), { getInner: true }),
      '<img src="hugerte/ui/img/raster.gif">'
    );
  });
