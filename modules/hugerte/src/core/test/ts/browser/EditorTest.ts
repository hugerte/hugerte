...
import { Attribute, Class, SugarBody } from "@hugerte/sugar";
...
import { BeforeSetContentEvent, SaveContentEvent, SetContentEvent } from 'hugerte/core/api/EventTypes';
...
import { UndoLevel } from 'hugerte/core/undo/UndoManagerTypes';

import * as HtmlUtils from '../module/test/HtmlUtils';

describe('browser.hugerte.core.EditorTest', () => {
