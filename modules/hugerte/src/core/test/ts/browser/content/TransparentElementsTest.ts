...
import { Hierarchy, Html, Insert, Remove, SugarBody, SugarElement, SugarNode } from "@hugerte/sugar";
import { assert } from 'chai';

import AstNode from 'hugerte/core/api/html/Node';
import Schema from 'hugerte/core/api/html/Schema';
import * as TransparentElements from 'hugerte/core/content/TransparentElements';

describe('browser.hugerte.core.content.TransparentElementsTest', () => {
  const schema = Schema();
