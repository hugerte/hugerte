...
import { UploadResult } from 'hugerte/core/api/EditorUpload';
...
const randBlobDataUri = (width: number, height: number) => {
  ...
  imageData.data.set(Array.from({ length: imageData.data.length }, () => random(0, 255)));
...
describe('browser.hugerte.core.EditorUploadTest', () => {
