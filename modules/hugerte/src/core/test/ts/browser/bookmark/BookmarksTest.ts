...
} from 'hugerte/core/bookmark/BookmarkTypes';
import * as GetBookmark from 'hugerte/core/bookmark/GetBookmark';
import * as ResolveBookmark from 'hugerte/core/bookmark/ResolveBookmark';

describe('browser.hugerte.core.bookmark.BookmarksTest', () => {
