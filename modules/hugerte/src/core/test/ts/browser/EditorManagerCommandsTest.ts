...
describe('browser.hugerte.core.EditorManagerCommandsTest', () => {
  ...
  it('mceAddEditor', (done) => {
    viewBlock.update('<textarea id="ed_1" class="hugerte"></textarea><textarea id="ed_2" class="hugerte"></textarea>');
    EditorManager.init({
