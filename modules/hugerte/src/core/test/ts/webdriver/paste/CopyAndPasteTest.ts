import { Cursors, RealClipboard, RealKeys } from "@hugerte/agar";
...
import CodePlugin from 'hugerte/plugins/code/Plugin';

import * as PasteEventUtils from '../../module/test/PasteEventUtils';

describe('webdriver.hugerte.core.paste.CopyAndPasteTest', () => {
