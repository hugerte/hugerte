...
UnitTest.test('UiSubstitutesTest', () => {
  Logger.sync(
    ...
    () => {
      const actual = UiSubstitutes.substitutePlaces('detail', { } as CompositeSketchDetail, [ ], { });
  ...
  Logger.sync(
    ...
    () => {
      const actual = UiSubstitutes.substitutePlaces('owner', 'detail' as unknown as CompositeSketchDetail, [
        { uiType: 'normal' }
      ] as ConfiguredPart[], { });
