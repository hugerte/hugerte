import { Attribute, Css, SugarNode, Traverse } from '@hugemce/sugar';
...
const createComponent = (component: AlloyComponent, blockerClass: string, blockerEvents: AlloyEventRecord): AlloyComponent =>
