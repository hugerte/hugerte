import { StructureProcessor, FieldSchema, StructureSchema, FieldProcessor } from '@hugemce/boulder';
import { Fun, Obj, Optional, Optionals, Thunk } from '@hugemce/katamari';
