import { FieldPresence, FieldProcessor, FieldSchema, StructureProcessor, StructureSchema, ValueType } from '@hugemce/boulder';
import { Adt, Fun, Id, Optional } from '@hugemce/katamari';
