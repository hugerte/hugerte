import { FieldPresence, FieldProcessor, FieldSchema, Objects, StructureSchema, ValueType } from '@hugemce/boulder';
import { Arr, Fun, Obj, Optional, Result } from '@hugemce/katamari';
