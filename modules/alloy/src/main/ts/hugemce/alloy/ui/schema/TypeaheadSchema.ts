        ...
        onHighlightItem: (_tmenu: AlloyComponent, menu: AlloyComponent, item: AlloyComponent): void => {
          if (!detail.previewing.get()) {
            ...
            detail.lazyTypeaheadComp.get().each((input) => {
              ...
              // https://github.com/tinymce/tinymce/blob/2d8c1c034e8aa484b868a0c44605489ee0ca9cd4/modules/alloy/src/main/ts/hugemce/alloy/ui/composite/TypeaheadSpec.ts#L282
