...
import { Class, Css, DomEvent, SelectorFind, SugarElement, SugarLocation } from '@hugemce/sugar';
...
import { DockingConfigSpec, DockingViewport } from 'hugemce/alloy/behaviour/docking/DockingTypes';
