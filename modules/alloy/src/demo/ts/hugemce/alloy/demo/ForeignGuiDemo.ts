...
import { Css, DomEvent, EventArgs, Height, Insert, InsertAll, SelectorFind, SugarElement, SugarElements, SugarNode, Width } from '@hugemce/sugar';
...
export default (): void => {
  ...
  Insert.append(hugemceUi, SugarElement.fromHtml('<h3>IFrame Editor</h3>'));
  Insert.append(hugemceUi, frame);
  Insert.append(hugemceUi, SugarElement.fromHtml('<h3>Div Editor</h3>'));
  Insert.append(hugemceUi, inlineContainer);
