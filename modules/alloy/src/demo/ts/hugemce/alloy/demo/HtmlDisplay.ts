import { Id, Thunk } from '@hugemce/katamari';
import { DomEvent, Html, SugarElement, TextContent } from '@hugemce/sugar';
...
import * as Channels from 'hugemce/alloy/api/messages/Channels';
